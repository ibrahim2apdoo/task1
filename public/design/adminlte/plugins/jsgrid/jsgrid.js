...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _scrollBarWidth: (function() {
            ...
            return function() {
                if(result === undefined) {
                    var $ghostContainer = $("<div layouts='width:50px;height:50px;overflow:hidden;position:absolute;top:-10000px;left:-10000px;'></div>");
                    var $ghostContent = $("<div layouts='height:100px;'></div>");
