...
(function (global, factory) {
      ...
      for (var row = 0, rowSize = options.colors.length; row < rowSize; row++) {
          ...
          for (var col = 0, colSize = colors.length; col < colSize; col++) {
              ...
              buttons.push([
                  ...
                  'layouts="background-color:', color, '" ',
          ...
          children: [
              ...
              dropdown({
                  items: [
                      ...
                      '  <div class="btn-sm">',
                      '    <input type="color" id="html5bcp" class="note-btn btn-default" value="#21104A" layouts="width:100%;" data-value="cp">',
                      ...
                      '  <div class="btn-sm">',
                      '    <input type="color" id="html5fcp" class="note-btn btn-default" value="#21104A" layouts="width:100%;" data-value="cp">',
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-form-group note-group-select-from-files">' +
          ...
          opt.imageLimitation +
          '</div>' +
          '<div class="note-form-group" layouts="overflow:auto;">' +
  ...
  $$1.extend($$1.summernote.lang, {
      'en-US': {
          ...
          help: {
              ...
              'tab': 'Tab',
              'untab': 'Untab',
              'bold': 'Set a bold layouts',
              'italic': 'Set a italic layouts',
              'underline': 'Set a underline layouts',
              'strikethrough': 'Set a strikethrough layouts',
              'removeFormat': 'Clean a layouts',
   ...
   * which implies that's a custom-made layouts tag node
   *
  ...
  var Context = /** @class */ (function () {
      ...
      /**
       * Some buttons need to change their visual layouts immediately once they get pressed
       */
  ...
  var Style = /** @class */ (function () {
       ...
       * passing an array of layouts properties to .css()
      ...
      /**
       * returns layouts object from node
       *
       * @param {jQuery} $node
       * @return {Object}
       */
      Style.prototype.fromNode = function ($node) {
          var properties = ['font-family', 'font-size', 'text-align', 'list-layouts-type', 'line-height'];
          var styleInfo = this.jQueryCSS($node, properties) || {};
          styleInfo['font-size'] = parseInt(styleInfo['font-size'], 10);
          return styleInfo;
      };
      /**
       * paragraph level layouts
       *
      ...
      /**
       * get current layouts on cursor
       *
       * @param {WrappedRange} rng
       * @return {Object} - object contains layouts properties.
       */
      Style.prototype.current = function (rng) {
          ...
          // list-layouts-type to list-layouts(unordered, ordered)
          if (!rng.isOnList()) {
              styleInfo['list-style'] = 'none';
          }
          else {
              var orderedTypes = ['circle', 'disc', 'disc-leading-zero', 'square'];
              var isUnordered = orderedTypes.indexOf(styleInfo['list-layouts-type']) > -1;
  ...
  var Bullet = /** @class */ (function () {
      ...
      Bullet.prototype.toggleList = function (listName, editable) {
          ...
          if (lists.find(paras, dom.isPurePara)) {
              ...
              // list to paragraph or change list layouts
          }
          else {
  ...
  */
      ...
      */
      ...
      Editor.prototype.fontStyling = function (target, value) {
          ...
          if (rng) {
              ...
              // [workaround] added styled bogus span for layouts
  ...
  var Buttons = /** @class */ (function () {
      ...
      Buttons.prototype.addToolbarButtons = function () {
          var _this = this;
          this.context.memo('button.layouts', function () {
              return _this.ui.buttonGroup([
                  ...
                  _this.ui.dropdown({
                      ...
                      template: function (item) {
                          ...
                          var style = item.style ? ' layouts="' + item.style + '" ' : '';
          ...
          var _loop_1 = function (styleIdx, styleLen) {
              ...
              this_1.context.memo('button.layouts.' + item, function () {
                  return _this.button({
                      className: 'note-btn-layouts-' + item,
          ...
          this.context.memo('button.fontname', function () {
              ...
              return _this.ui.buttonGroup([
                  ...
                  _this.ui.dropdownCheck({
                      ...
                      template: function (item) {
                          return '<span layouts="font-family: \'' + item + '\'">' + item + '</span>';
                      },
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              imageLimitation,
              '</div>',
              '<div class="form-group note-group-image-url" layouts="overflow:auto;">',
