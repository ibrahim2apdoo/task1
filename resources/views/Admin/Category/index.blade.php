                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">  {{trans('category.category_list')}}
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="col-lg-12 col-md-12 col-xm-12">
                <div class="card ">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form"> {{trans('category.category_list')}} </h4>
                    ...
                    <div class="card-body">
                        @include('Admin.layouts.massage')
                            ...
                            <tr>
                                ...
                                <th>{{trans('category.number_of_product')}}  </th>
