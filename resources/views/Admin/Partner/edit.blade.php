                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{trans('partner.partner_edit')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{trans('partner.partner_edit')}} </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('Partner.update',$partners->id)}}"
                                              method="post"
                                              enctype="multipart/form-data">
                                            @csrf
                                            <input name="id" value="{{$partners -> id}}" type="hidden">

                                            <div class="form-group">
                                                    <div class="text-center" style="width: 150px; height: 150px">
                                                        <img
                                                            src="{{asset($partners -> logo)}} "
                                                            class="rounded-circle  height-50" alt="صورة المنتج  " style="width: 100%;height: 100%">
                                                    </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$partners->getTranslation('name', 'ar')}}" name="name_ar"
                                                                   class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$partners->getTranslation('name', 'en')}}" name="name_en"
                                                                   class="form-control"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$partners->getTranslation('description', 'ar')}}" name="description_ar"
                                                                   class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$partners->getTranslation('description', 'en')}}" name="description_en"
                                                                   class="form-control"
